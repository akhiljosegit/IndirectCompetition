...
API_KEY = "AIzaSyB8Rjd014uc-55DT6XJrViHU3N4FsPOG5k" # User provided API key, kept as is.
...
def generate_gemini_prompt_summary_string(df_combined, your_account_name, feature_importances_df):
    ...
    """
    summary = f"I am analyzing LinkedIn data for my account '{your_account_name}' against indirect competitors. "
    summary += "My goal is to suggest a social media strategy to improve its engagement. "
